      ...
      buttons: [
        {
          ...
          action: () => {
            // Set 'showGuide' to 'true' in local storage
...
const captureElement = () => {
  ...
  if (elementToCapture) {
    domtoimage.toPng(elementToCapture).then((dataUrl) => {
      ...
      setTimeout(() => {
        document.querySelector('#img-rendered').classList.add('translateRight');
        setTimeout(() => {
  ...
  <div class="px-12 py-12" v-else>
    ...
    <div class="main px-12 py-12">
      ...
      <div class="relative">
        ...
        <div id="img-rendered" class=" bg-slate-800 pt-2 rounded-md w-1/5" v-if="showImage">
          <div class="w-5/5 bg-white mx-2">
            <a :href="imageUrl" download="captured_image.jpg">
              <img :src="imageUrl" alt="Captured Image" />
            </a>
          </div>
          <a :href="imageUrl" download="captured_image.jpg"><MainButton class="m-auto my-4" :buttonState="3">Télécharger</MainButton></a>
        </div>
        <div class="actions-buttons pt-8 w-4/6 m-auto flex justify-center">
          <MainButton  @click="captureElement" svgFileName="capture" :buttonState="2">Capturer</MainButton>
...
#img-rendered{
    ...
    animation: translateLeft 0.8s ease-in-out;
    bottom: 5%;
}
